...
@Component({
  selector: 'app-sucu05-button0010003',
  templateUrl: './sucu05-button0010003.component.html',
  styles: [
    `
    [nz-button] {
      margin-right: 8px;
...
export class Sucu05Button0010003Component implements OnInit {
  serviceId;
  @Input() sets = {
    "style": {
      "text": "删除",
  ...
  onClick(): void {
    console.log("删除:" + this.sets.style.table);
